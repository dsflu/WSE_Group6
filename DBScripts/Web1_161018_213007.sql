...
-- Campaign_Tag [rel4]
alter table "public"."tag"  add column  "campaign_oid_campaign"  int4;
alter table "public"."tag"   add constraint fk_tag_campaign foreign key ("campaign_oid_campaign") references "public"."campaign" ("oid_campaign");
