...
-- Campaign_Answer [rel10]
alter table "public"."answer"  add column  "campaign_oid_campaign"  int4;
alter table "public"."answer"   add constraint fk_answer_campaign foreign key ("campaign_oid_campaign") references "public"."campaign" ("oid_campaign");
...
create table "public"."question" (
   "oid_answer"  int4 not null,
   "question_oid_question"  int4 not null,
  primary key ("oid_answer", "question_oid_question")
);
alter table "public"."question"   add constraint fk_question_answer foreign key ("oid_answer") references "public"."answer" ("oid_answer");
alter table "public"."question"   add constraint fk_question_question foreign key ("question_oid_question") references "public"."question" ("oid_question");
